...
- NEAR Appchain infrastructure (See [octopus-appchain-anchor](https://github.com/octopus-network/octopus-appchain-anchor), one of the most complicated smart contracts on NEAR protocol.)
